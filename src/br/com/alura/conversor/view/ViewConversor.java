...
import br.com.alura.conversor.calculator.Conversor;
import br.com.alura.conversor.calculator.TipoConversaoEnum;
import br.com.alura.conversor.calculator.TipoConversaoTemperatura;

import br.com.alura.conversor.validator.Validador;
...
public class ViewConversor {
	...
	/**
	 * Chamadada da janela principal ({@link JOptionPane}) do programa.
	 */
	...
	/**
	 * Chamada o metodo de acordo com o que deseja converter.
	 * 
